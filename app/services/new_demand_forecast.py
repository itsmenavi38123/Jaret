...
def get_demand_forecast_system_prompt() -> str:
    return get_demand_forecast_prompt()


FULL_SYSTEM_PROMPT = get_demand_forecast_prompt()
...
async def _call_ai_agent(payload: Dict[str, Any], user_id: str) -> Dict[str, Any]:
    ...
    system_prompt = get_demand_forecast_prompt()
